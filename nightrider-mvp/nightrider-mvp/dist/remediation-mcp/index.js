...
Return JSON with:
{
  ...
  server.tool("scale-service", {
    ...
    replicas: external_exports.number().describe("Target number of replicas"),
    namespace: external_exports.string().optional().describe("Kubernetes namespace (default: production)")
  ...
  server.tool("get-remediation-status", {
    actionId: external_exports.string().optional().describe("Specific action ID to check")
...
export {
  remediation_mcp_default as default,
  implementation
};
